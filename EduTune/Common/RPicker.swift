...
@objc open class RPicker: NSObject {
    ...
    @objc class func selectDate(title: String? = nil,
                          cancelText: String = "Cancel".localized(),
                          doneText: String = "Apply".localized(),
...
class RPickerController: UIViewController {
    ...
    var doneText: String = "Apply".localized()
    ...
    private let buttonColor = UIColor.white // UIColor(red: 72/255, green: 152/255, blue: 240/255, alpha: 1)
    ...
    private func setUpThemeMode(isDark: Bool) {
        ...
        if isDark {
            ...
            toolBarView.backgroundColor = UIColor.init(hex: "335EF7", alpha: 1)
...
extension RPickerController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if (pickerLabel == nil) {
            pickerLabel = UILabel()
            pickerLabel?.font = UIFont(name: "Montserrat-Medium", size: 18)
